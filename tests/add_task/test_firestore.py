...
# def firestore_client(mocker):
#     # Mock the Firestore client with emulator settings
#     client = firestore.Client()
#     mocker.patch.object(firestore, "Client", return_value=client)
#     client._firestore_emulator_host = "localhost:8080"
#
